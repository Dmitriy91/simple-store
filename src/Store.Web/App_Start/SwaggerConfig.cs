...
using Store.Web.Infrastructure.Swagger;
...
namespace Store.Web
{
    ...
    {
        private static readonly string _origin;

        static SwaggerConfig()
        {
            _origin = ConfigurationManager.AppSettings["origin"];

            if (string.IsNullOrWhiteSpace(_origin))
                throw new ConfigurationMissingException("origin key was not specified", "AppSettings.config", 0);
        }
                ...
                .EnableSwagger("docs/{apiVersion}/help", c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Store.Web");
                        ...
                        c.OAuth2("oauth2")
                            ...
                            .Flow("implicit")
                            .AuthorizationUrl(_origin +"/#/login")
                            .TokenUrl(_origin + "/token")
                            .Scopes(scopes =>
                            {
